...
def register_tools(server: FastMCP) -> None:
    ...
    async def apps_next_range(session_id: str | None = None, ctx: Context | None = None) -> dict[str, Any]:
    ...
    async def apps_prev_range(session_id: str | None = None, ctx: Context | None = None) -> dict[str, Any]:
    ...
    async def apps_today(session_id: str | None = None, ctx: Context | None = None) -> dict[str, Any]:
