...
def register(server: FastMCP) -> None:
    ...
    async def create_label(request: LabelCreateRequest, ctx: Context) -> dict[str, Any]:
    ...
    async def update_label(request: LabelUpdateRequest, ctx: Context) -> dict[str, Any]:
    ...
    async def delete_label(request: LabelDeleteRequest, ctx: Context) -> dict[str, Any]:
    ...
    async def apply_labels(request: ModifyMessageRequest, ctx: Context) -> dict[str, Any]:
